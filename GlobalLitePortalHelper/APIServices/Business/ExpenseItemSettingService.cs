...
namespace PlugLitePortalHelper.APIServices
{
    ...
    public class ExpenseItemSettingServices
    {
        public static ExpenseItemSettingRespObj LoadExpenseItemSettings(ExpenseItemSettingSearchObj regObj, string username)
        {
            var response = new ExpenseItemSettingRespObj
            {
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.LOAD_EXPENSE_ITEM_SETTINGS_ENDPOINT, username, Method.POST).ProcessAPI<ExpenseItemSettingSearchObj, ExpenseItemSettingRespObj>(regObj, out var msg);
        ...
        public static ExpenseItemSettingRegRespObj UpdateExpenseItemSetting(EditExpenseItemSettingObj regObj, string username)
        {
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.UPDATE_EXPENSE_ITEM_SETTING_ENDPOINT, username, Method.POST).ProcessAPI<EditExpenseItemSettingObj, ExpenseItemSettingRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
