...
namespace PlugLitePortalHelper.APIServices
{
    ...
    public class WorkflowSettingServices
    {
        public static  WorkflowSettingRespObj LoadWorkflowSettings( WorkflowSettingSearchObj regObj, string username)
        {
            var response = new  WorkflowSettingRespObj
            {
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.LOAD_WORKFLOW_SETTINGS_ENDPOINT, username, Method.POST).ProcessAPI< WorkflowSettingSearchObj,  WorkflowSettingRespObj>(regObj, out var msg);
        ...
        public static WorkflowSettingRegRespObj AddWorkflowSetting(RegWorkflowSettingObj regObj, string username)
        {
            var response = new WorkflowSettingRegRespObj
            {
                Status = new APIResponseStatus
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.ADD_WORKFLOW_SETTING_ENDPOINT, username, Method.POST).ProcessAPI<RegWorkflowSettingObj, WorkflowSettingRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
