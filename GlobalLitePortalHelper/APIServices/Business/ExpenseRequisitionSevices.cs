...
namespace PlugLitePortalHelper.APIServices
{
    ...
    public class ExpenseLookupServices
    {
        ...
        public static ExpenseRequisitionRegRespObj UpdateExpenseRequisition(EditExpenseRequisitionObj regObj, string username)
        {
            var response = new ExpenseRequisitionRegRespObj
            {
                Status = new APIResponseStatus
                {
                    IsSuccessful = false,
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.UPDATE_EXPENSE_REQUISITION_ENDPOINT, username, Method.POST).ProcessAPI<EditExpenseRequisitionObj, ExpenseRequisitionRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
        ...
        public static ExpenseRequisitionRegRespObj AddExpenseRequisition(RegExpenseRequisitionObj regObj, string username)
        {
            var response = new ExpenseRequisitionRegRespObj
            {
                Status = new APIResponseStatus
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.ADD_EXPENSE_REQUISITION_ENDPOINT, username, Method.POST).ProcessAPI<RegExpenseRequisitionObj, ExpenseRequisitionRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
