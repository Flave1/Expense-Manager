...
namespace PlugLitePortalHelper.APIServices
{
    ...
    public class WorkflowItemServices
    {
        ...
        public static WorkflowItemRegRespObj UpdateWorkflowItem(EditWorkflowItemObj regObj, string username)
        {
            var response = new WorkflowItemRegRespObj
            {
                Status = new APIResponseStatus
                {
                    IsSuccessful = false,
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.UPDATE_WORKFLOW_ITEM_ENDPOINT, username, Method.POST).ProcessAPI<EditWorkflowItemObj, WorkflowItemRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
        ...
        public static WorkflowItemRegRespObj AddWorkflowItem(RegWorkflowItemObj regObj, string username)
        {
            var response = new WorkflowItemRegRespObj
            {
                Status = new APIResponseStatus
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.ADD_WORKFLOW_ITEM_ENDPOINT, username, Method.POST).ProcessAPI<RegWorkflowItemObj, WorkflowItemRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
