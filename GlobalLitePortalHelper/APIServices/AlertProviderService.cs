...
namespace GlobalLitePortalHelper.APIServices
{
    ...
    {
        public static AlertProviderRegRespObj AddAlertProvider(RegAlertProviderObj regObj, string username)
        {
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.ADD_ALERT_PROVIDER_ENDPOINT, username, Method.POST).ProcessAPI<RegAlertProviderObj, AlertProviderRegRespObj>(regObj, out var msg);
        ...
        public static AlertProviderRegRespObj UpdateAlertProvider(EditAlertProviderObj regObj, string username)
        {
            var response = new AlertProviderRegRespObj
            {
                Status = new APIResponseStatus
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.UPDATE_ALERT_PROVIDER_ENDPOINT, username, Method.POST).ProcessAPI<EditAlertProviderObj, AlertProviderRegRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
        ...
        public static AlertProviderRespObj LoadAlertProviders(AlertProviderSearchObj regObj, string username)
        {
            ...
            try
            {
                ...
                var apiResponse = new APIHelper(APIEndpoints.LOAD_ALERT_PROVIDERS_ENDPOINT, username, Method.POST).ProcessAPI<AlertProviderSearchObj, AlertProviderRespObj>(regObj, out var msg);
                if (msg.Code == 0 && string.IsNullOrEmpty(msg.TechMessage) && string.IsNullOrEmpty(msg.Message))
                {
                    return apiResponse;
                }
